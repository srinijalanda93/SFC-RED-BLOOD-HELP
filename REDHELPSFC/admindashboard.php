...
<body style="color:black;" >
  ...
  include 'connection.php'; //connection
    include 'adminsession.php'; //admin session
    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
    ?>

<div id="header">
<?php include 'adminheader.php'; //admin header.php
?>
</div>
<div id="sidebar">
<?php
$active="dashboard";
include 'adminsidebar.php'; //admin sidebar.php
?> 
              ...
              <div class="panel panel-default panel-info" style="border-radius:50px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#D6EAF8; border-radius:50px">
                  <div class="stat-panel text-center">
                    ...
                    <div class="stat-panel-title text-uppercase">Blood Donors Available </div><!--done-->
                    <br>
                      <button class="btn btn-danger" onclick="window.location.href = 'admindonor_list.php';"><!--done-->
                        Full Detail <i class="fa fa-arrow-right"></i><!--done-->
                      </button>
            ...
            <div class="col-md-3">
              <div class="panel panel-default panel-info" style="border-radius:50px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#ABEBC6;border-radius:50px;">
                  <div class="stat-panel text-center">
                    <?php
                      $sql1 =" SELECT * from contact_query "; //done
                    ...
                    <br>
                    <button class="btn btn-danger" onclick="window.location.href = 'adminquery.php';"><!--done-->
                      Full Detail <i class="fa fa-arrow-right"></i><!--done-->
                    </button>
                  </div>
                </div>
...
<?php
                    ...
                    <div class="stat-panel-title text-uppercase">Blood Dashboard </div>
                    <br>
                    <button class="btn btn-danger" onclick="window.location.href = 'blooddashboard.php';">
