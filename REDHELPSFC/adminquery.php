...
<div id="sidebar">
<?php $active="query"; include 'adminsidebar.php'; //done
?>
...
<td><a href="adminquery.php?id=<?php echo $row['query_id'];?>" onclick="clickme()"><b id="demo">Pending</b></a><br>
...
<?php } ?>
    ...
    <div class="table-responsive"style="text-align:center;align:center">
        ...
        if(mysqli_num_rows($result1) > 0){
          ...
          if($page > 1){
            echo '<li><a href="adminquery.php?page='.($page - 1).'">Prev</a></li>';
          }
          for($i = 1; $i <= $total_page; $i++){
            ...
            echo '<li class="'.$active.'"><a href="adminquery.php?page='.$i.'">'.$i.'</a></li>';
          }
          if($total_page > $page){
            echo '<li><a href="adminquery.php.php?page='.($page + 1).'">Next</a></li>';
          }
