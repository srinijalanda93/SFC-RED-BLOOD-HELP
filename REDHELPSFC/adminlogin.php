...
<body background="redhelpimages/adminbg.png">
  ...
  if(isset($_POST["login"])){
    ...
    if(mysqli_num_rows($result)>0)
    {
      ...
      echo '<div class="alert alert-danger" style="font-weight:bold;text-align:center;font-size:25px"> Username and Password are not matched!</div>';
    }
   ...
   ?>
    <div class="container" style="margin-top:20px;">
      <div class="row justify-content-center">
          <div class="col-lg-4"><!---class="col-lg-6"--->
            <center>    <img src="redhelpimages/sfcredHELP.PNG"/></center>
              <h1 class="mt-4 mb-3" style="color:Black;">
                 SFC RED HELP Admin Login Portal
                </h1>
            </div>
      </div>
      <div class="card" style="height:250px; background-image:url('Homepics/glossy1.jpg');">
          <div class="card-body">
