  ...
  <div class="content-wrapper">
    ...
    <div class="table-responsive"style="text-align:center;align:center">
        ...
        if(mysqli_num_rows($result1) > 0){
          ...
          if($page > 1){
            echo '<li><a href="adminpages.php?page='.($page - 1).'">Prev</a></li>';//done
          }
          for($i = 1; $i <= $total_page; $i++){
            ...
            echo '<li class="'.$active.'"><a href="adminpages.php?page='.$i.'">'.$i.'</a></li>';//done
          }
          if($total_page > $page){
            echo '<li><a href="adminpages.php?page='.($page + 1).'">Next</a></li>';//done
          }
